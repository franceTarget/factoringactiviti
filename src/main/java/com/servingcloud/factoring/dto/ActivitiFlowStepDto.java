package com.servingcloud.factoring.dto;
...
public class ActivitiFlowStepDto {
    ...
    private List<ActivitiFlowStepDto> childList;

    public List<ActivitiFlowStepDto> getChildList() {
        return childList;
    }

    public void setChildList(List<ActivitiFlowStepDto> childList) {
