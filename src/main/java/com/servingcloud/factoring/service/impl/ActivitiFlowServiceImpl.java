package com.servingcloud.factoring.service.impl;
    ...
    private String createActivitiProcess(ActivitiFlowRequestDto activitiFlowRequestDto,
        ...
        try {
            ...
            InputStream processBpmn = processEngine.getRepositoryService().getResourceAsStream(deployment.getId(),
                process.getId() + ".bpmn");
            FileUtils.copyInputStreamToFile(processBpmn, new File("D:/workspace/demo/activiti-demo/src/main/resources" + process.getId() +
                ".bpmn"));
        } catch (Exception e) {
            e.printStackTrace();
        }
