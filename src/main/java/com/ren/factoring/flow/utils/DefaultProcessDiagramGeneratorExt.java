...
public class DefaultProcessDiagramGeneratorExt {
    ...
    public DefaultProcessDiagramGeneratorExt() {
        this(1.0D);
    }

    public DefaultProcessDiagramGeneratorExt(final double scaleFactor) {
        this.activityDrawInstructions = new HashMap();
        this.artifactDrawInstructions = new HashMap();
        this.activityDrawInstructions.put(StartEvent.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
        ...
        this.activityDrawInstructions.put(IntermediateCatchEvent.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ThrowEvent.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EndEvent.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(Task.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(UserTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ScriptTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ServiceTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ReceiveTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(SendTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ManualTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(BusinessRuleTask.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ExclusiveGateway.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(InclusiveGateway.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(ParallelGateway.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EventGateway.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(BoundaryEvent.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(SubProcess.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.activityDrawInstructions.put(EventSubProcess.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
                if (graphicInfo.getExpanded() != null && !graphicInfo.getExpanded().booleanValue()) {
        ...
        this.activityDrawInstructions.put(CallActivity.class, new DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode) {
                GraphicInfo graphicInfo = bpmnModel.getGraphicInfo(flowNode.getId());
        ...
        this.artifactDrawInstructions.put(TextAnnotation.class, new DefaultProcessDiagramGeneratorExt.ArtifactDrawInstruction() {
            @Override
        ...
        this.artifactDrawInstructions.put(Association.class, new DefaultProcessDiagramGeneratorExt.ArtifactDrawInstruction() {
            @Override
            public void draw(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
                ...
                graphicInfoList = DefaultProcessDiagramGeneratorExt.connectionPerfectionizer(processDiagramCanvas, bpmnModel, (BaseElement) sourceElement, (BaseElement) targetElement, graphicInfoList);
    ...
    protected void drawActivity(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode, List<String> highLightedFinishes, List<String> highLightedActivities, List<String> highLightedFlows, double scaleFactor) {
        DefaultProcessDiagramGeneratorExt.ActivityDrawInstruction drawInstruction = this.activityDrawInstructions.get(flowNode.getClass());
        boolean highLighted;
    ...
    protected void drawArtifact(DefaultProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, Artifact artifact) {
        DefaultProcessDiagramGeneratorExt.ArtifactDrawInstruction drawInstruction = this.artifactDrawInstructions.get(artifact.getClass());
        if (drawInstruction != null) {
