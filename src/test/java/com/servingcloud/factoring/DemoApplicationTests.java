...
public class DemoApplicationTests {
    ...
    public void deployTest() throws Exception{
        //请假流程的模型
        Model model = repositoryService.createModelQuery().modelKey("modelKey1").singleResult();
        ...
        Deployment deployment = repositoryService.createDeployment().key("p1234").name("请假")
